...
def render_task_submodule():
    ...
    parent_col_config = {"task_name": st.column_config.TextColumn(label="Name",
                        ...
                        "execution_logic": st.column_config.TextColumn(label="Logic used:",
                                                                       disabled=True),
                        "updated_through_date": st.column_config.DateColumn(label="Value Recency",
                                                                            pinned=False,
                                                                            disabled=True),
                        "execution_delta_h": st.column_config.ProgressColumn(label="Execution",
                                                                             width="small",
                                                                             format='%d',
                                                                             min_value=0,
                                                                             max_value=24),
                        "success_delta_h": st.column_config.ProgressColumn(label="Success",
                                                                              width="small",
                                                                              format='%d',
                                                                              min_value=0,
                                                                              max_value=24),
                         "failure_delta_h": st.column_config.ProgressColumn(label="Failure",
                                                                              width="small",
                                                                              format='%d',
                                                                              min_value=0,
                                                                              max_value=24),
